 ...
 * @author ss047890
 *
 *         A Spring Data JPA MemberEventRel repository. An implementation of this interface gets
 *         auto-generated--no need to implement it by hand.
 */
public interface MemberEventRelRepository extends JpaRepository<MemberEventRel, Long>
{
}
