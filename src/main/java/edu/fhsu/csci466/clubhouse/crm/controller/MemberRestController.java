...
public class MemberRestController
{
    ...
    public HttpEntity<Member> updateMember( @RequestBody Member member, Model model )
    {
    ...
    public HttpEntity<Member> makePayment( @PathVariable Long id, @PathVariable Double payment )
    {
        Member member = service.getMember( id );
        HttpStatus status = service.makePayment( id, payment ) ? HttpStatus.OK : HttpStatus.NOT_FOUND;
        return new ResponseEntity<>( member, status );
    }
}
