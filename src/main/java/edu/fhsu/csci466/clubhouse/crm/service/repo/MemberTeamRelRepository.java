 ...
 * @author ss047890
 *
 *         A Spring Data JPA MemberTeamRel repository. An implementation of this interface gets
 *         auto-generated--no need to implement it by hand.
 */
public interface MemberTeamRelRepository extends JpaRepository<MemberTeamRel, Long>
{
}
